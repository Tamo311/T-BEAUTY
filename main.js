...
/////============================= burger menu dropdown
     ...
     BG_a2.addEventListener("click",function(){
        document.getElementById("BG_service_dropdown").classList.toggle("burger_service_dropdown")
        BG_i_services.classList.toggle("burger_arrow_rotate") 
     })
    BG_a3.addEventListener("click",function(){
        document.getElementById("BG_product_dropdown").classList.toggle("burger_product_dropdown")
